...
namespace Hamilton\PayPal\Core;

use Hamilton\PayPal\Log\PayPalLogFactory;
...
class PayPalLoggingManager
{
    ...
    private function __construct($loggerName)
    {
        ...
        $factory = array_key_exists('log.AdapterFactory', $config) && in_array('Hamilton\PayPal\Log\PayPalLogFactory', class_implements($config['log.AdapterFactory'])) ? $config['log.AdapterFactory'] : 'Hamilton\PayPal\Log\PayPalDefaultLogFactory';
