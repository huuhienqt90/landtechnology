...
namespace Hamilton\PayPal\Common;

use Hamilton\PayPal\Rest\ApiContext;
use Hamilton\PayPal\Rest\IResource;
...
class PayPalResourceModel extends PayPalModel implements IResource
{
     ...
     */
    protected static function executeCall($url, $method, $payLoad, $headers = array(), $apiContext = null, $restCall = null, $handlers = array('Hamilton\PayPal\Handler\RestHandler'))
    {
