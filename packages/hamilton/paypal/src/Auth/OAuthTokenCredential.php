...
namespace Hamilton\PayPal\Auth;

use Hamilton\PayPal\Cache\AuthorizationCache;
use Hamilton\PayPal\Common\PayPalResourceModel;
use Hamilton\PayPal\Core\PayPalHttpConfig;
use Hamilton\PayPal\Core\PayPalHttpConnection;
use Hamilton\PayPal\Core\PayPalLoggingManager;
use Hamilton\PayPal\Exception\PayPalConfigurationException;
use Hamilton\PayPal\Exception\PayPalConnectionException;
use Hamilton\PayPal\Handler\IPayPalHandler;
use Hamilton\PayPal\Rest\ApiContext;
use Hamilton\PayPal\Security\Cipher;
...
class OAuthTokenCredential extends PayPalResourceModel
{
     ...
     */
    public static $AUTH_HANDLER = 'Hamilton\PayPal\Handler\OauthHandler';
     ...
     * @throws \Hamilton\PayPal\Exception\PayPalConnectionException
     */
