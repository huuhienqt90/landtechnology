...
use Hamilton\PayPal\Common\PayPalResourceModel;
use Hamilton\PayPal\Rest\ApiContext;
use Hamilton\PayPal\Transport\PayPalRestCall;
use Hamilton\PayPal\Validation\ArgumentValidator;
use Hamilton\PayPal\Validation\UrlValidator;
...
class Invoice extends PayPalResourceModel
{
     ...
     *
     * @param \Hamilton\PayPal\Api\MerchantInfo $merchant_info
     * 
     * @return $this
     */
     ...
     * Information about the merchant who is sending the invoice.
     *
     * @return \Hamilton\PayPal\Api\MerchantInfo
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\BillingInfo[] $billing_info
     * 
     * @return $this
     */
     ...
     * The required invoice recipient email address and any optional billing information. One recipient is supported.
     *
     * @return \Hamilton\PayPal\Api\BillingInfo[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\BillingInfo $billingInfo
     * @return $this
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\Participant[] $cc_info
     * 
     * @return $this
     */
     ...
     * For invoices sent by email, one or more email addresses to which to send a Cc: copy of the notification. Supports only email addresses under participant.
     *
     * @return \Hamilton\PayPal\Api\Participant[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\Participant $participant
     * @return $this
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\ShippingInfo $shipping_info
     * 
     * @return $this
     */
     ...
     * The shipping information for entities to whom items are being shipped.
     *
     * @return \Hamilton\PayPal\Api\ShippingInfo
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\InvoiceItem[] $items
     * 
     * @return $this
     */
     ...
     * The list of items to include in the invoice. Maximum value is 100 items per invoice.
     *
     * @return \Hamilton\PayPal\Api\InvoiceItem[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\InvoiceItem $invoiceItem
     * @return $this
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\PaymentTerm $payment_term
     * 
     * @return $this
     */
     ...
     * Optional. The payment deadline for the invoice. Value is either `term_type` or `due_date` but not both.
     *
     * @return \Hamilton\PayPal\Api\PaymentTerm
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\Cost $discount
     * 
     * @return $this
     */
     ...
     * The invoice level discount, as a percent or an amount value.
     *
     * @return \Hamilton\PayPal\Api\Cost
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\ShippingCost $shipping_cost
     * 
     * @return $this
     */
     ...
     * The shipping cost, as a percent or an amount value.
     *
     * @return \Hamilton\PayPal\Api\ShippingCost
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\CustomAmount $custom
     * 
     * @return $this
     */
     ...
     * The custom amount to apply on an invoice. If you include a label, the amount cannot be empty.
     *
     * @return \Hamilton\PayPal\Api\CustomAmount
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\Currency $minimum_amount_due
     * 
     * @return $this
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\Currency $total_amount
     * 
     * @return $this
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\PaymentDetail[] $payments
     * 
     * @return $this
     */
     ...
     * List of payment details for the invoice.
     *
     * @return \Hamilton\PayPal\Api\PaymentDetail[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\PaymentDetail $paymentDetail
     * @return $this
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\RefundDetail[] $refunds
     * 
     * @return $this
     */
     ...
     * List of refund details for the invoice.
     *
     * @return \Hamilton\PayPal\Api\RefundDetail[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\RefundDetail $refundDetail
     * @return $this
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\Metadata $metadata
     * 
     * @return $this
     */
     ...
     * Audit information for the invoice.
     *
     * @return \Hamilton\PayPal\Api\Metadata
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\PaymentSummary $paid_amount
     * 
     * @return $this
     */
     ...
     * Payment summary of the invoice including amount paid through PayPal and other sources.
     *
     * @return \Hamilton\PayPal\Api\PaymentSummary
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\PaymentSummary $refunded_amount
     * 
     * @return $this
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\FileAttachment[] $attachments
     * 
     * @return $this
     */
     ...
     * List of files attached to the invoice.
     *
     * @return \Hamilton\PayPal\Api\FileAttachment[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\FileAttachment $fileAttachment
     * @return $this
     */
