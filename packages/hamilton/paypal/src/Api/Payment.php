...
use Hamilton\PayPal\Core\PayPalConstants;
...
class Payment extends PayPalResourceModel
{
     ...
     *
     * @param \Hamilton\PayPal\Api\Payer $payer
     * 
     * @return $this
     */
     ...
     * Source of the funds for this payment represented by a PayPal account or a direct credit card.
     *
     * @return \Hamilton\PayPal\Api\Payer
     */
     ...
     * @param \Hamilton\PayPal\Api\PotentialPayerInfo $potential_payer_info
     * 
     * @return $this
     */
     ...
     * Information that the merchant knows about the payer.  This information is not definitive and only serves as a hint to the UI or any pre-processing logic.
     * @deprecated Not publicly available
     * @return \Hamilton\PayPal\Api\PotentialPayerInfo
     */
     ...
     * @param \Hamilton\PayPal\Api\Payee $payee
     * 
     * @return $this
     */
    ...
    /**
     * Receiver of funds for this payment.
     * @return \Hamilton\PayPal\Api\Payee
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\Transaction[] $transactions
     * 
     * @return $this
     */
     ...
     * Transactional details including the amount and item details.
     *
     * @return \Hamilton\PayPal\Api\Transaction[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\Transaction $transaction
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Hamilton\PayPal\Api\Error[] $failed_transactions
     * 
     * @return $this
     */
     ...
     * Applicable for advanced payments like multi seller payment (MSP) to support partial failures
     * @deprecated Not publicly available
     * @return \Hamilton\PayPal\Api\Error[]
     */
     ...
     * @deprecated Not publicly available
     * @param \Hamilton\PayPal\Api\Error $error
     * @return $this
     */
     ...
     * @deprecated Not publicly available
     * @param \Hamilton\PayPal\Api\CreditFinancingOffered $credit_financing_offered
     * 
     * @return $this
     */
     ...
     * Credit financing offered to payer on PayPal side. Returned in payment after payer opts-in
     * @deprecated Not publicly available
     * @return \Hamilton\PayPal\Api\CreditFinancingOffered
     */
     ...
     * @deprecated Not publicly available
     * @param \Hamilton\PayPal\Api\PaymentInstruction $payment_instruction
     * 
     * @return $this
     */
     ...
     * Instructions for the payer to complete this payment.
     * @deprecated Not publicly available
     * @return \Hamilton\PayPal\Api\PaymentInstruction
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\RedirectUrls $redirect_urls
     * 
     * @return $this
     */
     ...
     * Set of redirect URLs you provide only for PayPal-based payments.
     *
     * @return \Hamilton\PayPal\Api\RedirectUrls
     */
