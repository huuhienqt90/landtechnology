...
class FundingOption extends PayPalModel
{
     ...
     *
     * @param \Hamilton\PayPal\Api\FundingSource[] $funding_sources
     * 
     * @return $this
     */
     ...
     * List of funding sources that contributes to a payment.
     *
     * @return \Hamilton\PayPal\Api\FundingSource[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\FundingSource $fundingSource
     * @return $this
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\FundingInstrument $backup_funding_instrument
     * 
     * @return $this
     */
     ...
     * Backup funding instrument which will be used for payment if primary fails.
     *
     * @return \Hamilton\PayPal\Api\FundingInstrument
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\CurrencyConversion $currency_conversion
     * 
     * @return $this
     */
     ...
     * Currency conversion applicable to this funding option.
     *
     * @return \Hamilton\PayPal\Api\CurrencyConversion
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\InstallmentInfo $installment_info
     * 
     * @return $this
     */
     ...
     * Installment options available for a funding option.
     *
     * @return \Hamilton\PayPal\Api\InstallmentInfo
     */
