 ...
 * @package PayPal\Api
 *
 * @property \Hamilton\PayPal\Api\PayoutSenderBatchHeader sender_batch_header
 * @property \Hamilton\PayPal\Api\PayoutItem[] items
 * @property \Hamilton\PayPal\Api\Links[] links
 */
class Payout extends PayPalResourceModel
{
     ...
     *
     * @param \Hamilton\PayPal\Api\PayoutSenderBatchHeader $sender_batch_header
     *
     * @return $this
     */
     ...
     * The original batch header as provided by the payment sender.
     *
     * @return \Hamilton\PayPal\Api\PayoutSenderBatchHeader
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\PayoutItem[] $items
     *
     * @return $this
     */
     ...
     * An array of payout items (that is, a set of individual payouts).
     *
     * @return \Hamilton\PayPal\Api\PayoutItem[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\PayoutItem $payoutItem
     * @return $this
     */
