...
class InstallmentInfo extends PayPalModel
{
     ...
     *
     * @param \Hamilton\PayPal\Api\InstallmentOption[] $installment_options
     * 
     * @return $this
     */
     ...
     * List of available installment options and the cost associated with each one.
     *
     * @return \Hamilton\PayPal\Api\InstallmentOption[]
     */
     ...
     *
     * @param \Hamilton\PayPal\Api\InstallmentOption $installmentOption
     * @return $this
     */
