...
use Hamilton\PayPal\Common\PayPalUserAgent;
...
use Hamilton\PayPal\Exception\PayPalInvalidCredentialException;
use Hamilton\PayPal\Exception\PayPalMissingCredentialException;
...
class RestHandler implements IPayPalHandler
{
     ...
     * Private Variable
     *
     * @var \Hamilton\PayPal\Rest\ApiContext $apiContext
     */
    private $apiContext;
     ...
     * Construct
     *
     * @param \Hamilton\PayPal\Rest\ApiContext $apiContext
     */
     ...
     *
     * @return string
     * @throws \Hamilton\PayPal\Exception\PayPalConfigurationException
     */
