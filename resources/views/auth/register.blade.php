                                ...
                                {!! Form::open(['route' => 'register', 'files' => true, 'class' => 'form-horizontal', 'method' => 'POST']) !!}
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group {{ $errors->has('password_confirmation')? 'has-error' : '' }}">
                                            ...
                                            <div class="col-sm-10">
                                                {{ Form::password('password_confirmation', ['class' => 'form-control', 'placeholder' => 'Password', 'id' => 'input-confirm-password']) }}
                                                {{ Form::label(null, $errors->has('password_confirmation')? $errors->first('password_confirmation') : '', ['class' => 'help-block']) }}
                                            </div>
                                        </div>
                                    </fieldset>
                                    <div class="text-center mg-top-20">
                                        ...
                                        {{ Form::submit('Continue', ['class' => 'btn-main btn-primary']) }}
                                    </div>
                                {!! Form::close() !!}
                            </div>
                        </div>
